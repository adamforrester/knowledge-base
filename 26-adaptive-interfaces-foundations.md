...
## The fourteen experience patterns

Inside the four postures, Clark & Kindred (2026) name fourteen experience patterns that cover the currently observable shipped territory. We adopt this catalogue as our practice vocabulary, because no other published framework names the patterns at this level of specificity. Where we extend or qualify, we say so.
...
**Agents (interoperable corner) — Clark & Kindred's typology in Ch 8.**

- **Taskers.** Single-purpose execution agents — invoice classifiers, sentiment processors, the simplest end of the spectrum. Often act *as* tools to the rest of the system.
...
- **Stewards.** Long-running, accountable agents that take ownership of a recurring responsibility — a release-notes steward that watches the changelog and drafts publishable summaries; a triage steward that watches incoming issues and proposes labels and assignees (Linear Triage Intelligence is the canonical example).
