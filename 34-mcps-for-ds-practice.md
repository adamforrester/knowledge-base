...
- **Native vendor MCP support is starting to land in mid-2026.** Supernova has shipped MCP-endpoint distribution (private beta as of 2026-06-18). Specify, Knapsack, and Backlight remain API-only; native MCP from those three is the practice's bet for late 2026 / 2027. AI-readiness pressure is real, engineering work is bounded, commercial signal is clear; the trajectory is toward MCP-native within the next 12–18 months.
