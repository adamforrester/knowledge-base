...
- **Card vs the alternatives (the boundaries):**
  ...
  - **vs a list/table row** — the boundary is *data heterogeneity*: Cards for heterogeneous, image-heavy content; **lists/tables** for homogeneous, dense, comparable records that need rapid vertical scanning (don't card-ify a data table — Table not yet briefed).
