...
- **Aggregated by:** the **Error Summary** (form-level) and the **Form** composite — which realises this brief's "surviving form-level live region": Form moves the live region up to the error summary and drives the focus-on-submit, exactly as settled here (see form).
