...
- **Segmented Control** — *draft.* `scope: the group of the toggle button presented as a connected control; the single-select-radiogroup vs. multi-select-toggle-group ARIA fork; the segmented-vs-radio / segmented-vs-tabs / segmented-vs-select boundaries; segment-count + width constraints; the sliding indicator. Dual-agent run in _research/_inbound/2026-06-15-component-segmented-control/.`
