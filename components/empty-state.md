...
- **Composed by:** Table / List / Tree / search-results / card — the data hosts whose zero-state *is* the empty state (see table for the keystone host, list/tree when briefed).
