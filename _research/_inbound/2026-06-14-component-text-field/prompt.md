You are researching the Text Field component for a senior design systems
...
This is not an introductory guide. Assume the reader knows what a text
field is, knows what a design system is, and has shipped multiple
...
Depth: Expert audience. Do not explain what a text field is or that it
collects typed text — explain the label/validation/composition prop-model
decisions, semantics traps, and accessibility contracts field leaders
still disagree on.
