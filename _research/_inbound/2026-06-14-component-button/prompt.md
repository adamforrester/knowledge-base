You are researching the Button component for a senior design systems
...
This is not an introductory guide. Assume the reader knows what a button
...
Depth: Expert audience. Do not explain what a button is or that buttons
trigger actions — explain the prop-model decisions, semantics traps, and
accessibility contracts field leaders still disagree on.
